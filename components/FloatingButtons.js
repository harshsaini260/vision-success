...
const WELCOME_MSG = wa(
  `Namaste ${SITE.contactName}! Vision Success ke baare mein jaanna hai. Student naam: ___, Class: ___, Target exam: ___`
)
...
export default function FloatingButtons() {
  ...
  return (
    <>
      ...
      >
        <span className="fw-name" aria-hidden>WhatsApp {SITE.contactName}</span>
