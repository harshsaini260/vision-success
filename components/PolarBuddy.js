    ...
    >
      ...
      <svg viewBox="0 0 120 122" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        ...
        <g className="buddy-body">
          {/* ears */}
          <circle cx="34" cy="26" r="11" fill="var(--bone)" />
          <circle cx="86" cy="26" r="11" fill="var(--bone)" />
          <circle cx="34" cy="26" r="4.8" fill="var(--ink-3)" opacity="0.12" />
          <circle cx="86" cy="26" r="4.8" fill="var(--ink-3)" opacity="0.12" />

          {/* head */}
          <circle cx="60" cy="52" r="33" fill="var(--bone)" />

          {/* eyes (blink via CSS scaleY) */}
          <g className="buddy-eye" style={{ transformOrigin: '47px 48px' }}>
            <circle cx="47" cy="48" r="3.6" fill="var(--ink-3)" />
            <circle cx="48.3" cy="46.7" r="1.2" fill="#FFFDF5" />
          </g>
          <g className="buddy-eye" style={{ transformOrigin: '74px 46px' }}>
            <circle cx="74" cy="46" r="3.6" fill="var(--ink-3)" />
          ...
          <path d="M63 52.5 Q67.6 53.2 67.6 56.3 Q67.6 59.6 63 59.6 Q58.4 59.6 58.4 56.3 Q58.4 53.2 63 52.5 Z" fill="var(--ink-3)" />
          <path d="M63 60 Q63 63.8 67 64.4" stroke="var(--ink-3)" strokeWidth="1.6" strokeLinecap="round" />

          {/* body */}
          <ellipse cx="60" cy="96" rx="30" ry="22" fill="var(--bone)" />
          <ellipse cx="60" cy="101" rx="16" ry="12" fill="#FBF7EA" />

          {/* resting paw */}
          <ellipse cx="38" cy="106" rx="9" ry="6.5" fill="var(--bone)" />
        ...
        <g className="buddy-paw" style={{ transformOrigin: '86px 100px' }}>
          <ellipse cx="88" cy="94" rx="9.5" ry="7" fill="var(--bone)" transform="rotate(-32 88 94)" />
