...
/* ─── the offer ───
   ⚠ The institute's standing position is that ordinary fees are never
   published — they are set against what a family can manage and settled
   in free counselling. Nothing here breaks that. Only the two
   fixed-price products carry a struck-through number, and the rest is
   framed as what it is: a discount off admission, and funded seats.

   Change the numbers here and they change everywhere on the site. */
export const OFFER = {
  name: 'The Freedom Fortnight',
  seats: 8,
  seatLine: 'Eight fully-funded seats',
  seatBody:
    'One for each decade. A full year of coaching at no fee, for eight students who could do the ' +
    'work and cannot pay for it. No essay, no performance — you tell us your situation in the free ' +
    'counselling and we decide quietly. Nobody in your batch is ever told which seats these are.',
  off: 800,
  offBody:
    '₹800 off admission for anyone who joins before the 31st — on top of whatever fee your family ' +
    'and we agree on in counselling.',
  fixed: [
    { name: 'Board Crash Course', was: 5000, now: 4200, href: '/board-crash-course-una' },
    { name: 'Online NDA Course (1 year)', was: 5000, now: 4200, href: '/online-nda-course' },
  ],
