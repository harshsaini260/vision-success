...
export const EXAM_LANDINGS = {
  ...
  nda: {
    ...
    faqs: [
      ...
      { q: 'How are the fees?', a: 'Fees are set on your family’s ability and stay well below big-city coaching — your exact fee is confirmed in the free strategy session. No capable future officer is turned away over money.' },
    ],
    meta: {
  ...
  neet: {
    ...
    faqs: [
      ...
      { q: 'What about fees?', a: 'Fees are set on your family\'s ability and stay affordable — far less than metro coaching. Your exact fee is confirmed in the free strategy session. Talent is never turned away over money here.' },
    ],
    meta: {
  ...
  jee: {
    id: 'jee',
    emoji: '⚙️',
    courseValue: 'JEE Mains',
    h1a: 'Crack JEE Mains',
    h1b: 'With An NIT Grad In Your Corner',
    h1c: 'learn from faculty who actually sat in the seat you want',
    sub: 'Book a FREE 1-on-1 strategy session with our senior JEE faculty — an NIT Hamirpur alumnus who has coached 13+ years of selections.',
    scarcity: 'Only 10 free strategy sessions this month',
    trustRow: ['🎓 NIT Hamirpur alumnus mentor', '📝 Weekly NTA-pattern mocks', '👥 Max 15 per batch'],
    extraField: { key: 'currentClass', label: 'Current class (optional)', placeholder: 'e.g. Class 11 / Class 12 / Dropper' },
    funnel: [
      { icon: '📅', title: 'Book Your Slot', text: 'Pick a time. Zero payment, zero pressure.' },
      { icon: '🧪', title: 'Free Diagnostic', text: 'An NTA-pattern mini-test across Physics, Chemistry, Maths.' },
      { icon: '🗺️', title: 'Personal 300 Plan', text: 'Your percentile target, session calendar, and weekly plan — yours to keep.' },
    ],
    lessonsTag: 'Free Sample — We Teach Before You Pay',
    lessonsTitle: 'Three JEE Secrets, On The House',
    lessons: [
      {
        icon: '🎯',
        title: 'January Is A Free Scouting Mission',
        text: 'JEE Main runs twice a year and only your BEST session counts. Sit the January attempt even at 70% preparation — it costs you nothing, hands you real exam-pressure data, and lets you walk into April with the map already drawn.',
      },
      {
        icon: '🧮',
        title: 'The −1 Economics',
        text: 'At +4/−1, blind guessing at 25% accuracy nets you ZERO. But eliminate just one option and guessing turns mathematically profitable. We train elimination as a calculated investment — every attempt either earns or is skipped on purpose.',
      },
      {
        icon: '📜',
        title: 'PYQs Are The Real Syllabus',
        text: 'NTA recycles concept patterns relentlessly. Ten years of chapter-wise previous-year questions cover most of what the paper can legally throw at you. We drill PYQs weekly, chapter by chapter, until déjà vu becomes your exam-hall superpower.',
      },
    ],
    pattern: {
      title: 'Know Your Exam — JEE Main (NTA)',
      rows: [
        ['Format', 'Computer-based · 75 questions · 300 marks · 3 hrs'],
        ['Per subject', 'Physics / Chemistry / Maths — 25 Qs each (20 MCQ + 5 numerical)'],
        ['Marking', '+4 correct · −1 wrong'],
        ['Sessions', 'Twice a year (January + April) — best score counts'],
        ['The next level', 'Top ~2.5 lakh scorers qualify for JEE Advanced (IITs)'],
        ['Boards matter', '75% in Class 12 (or top-20 percentile) needed for NIT/IIIT seats'],
      ],
      note: 'Your mentor doesn\'t just teach this exam — he lives on the other side of it. NIT Hamirpur, class of proof.',
    },
    proof: {
      title: 'The Proof Has A Degree From Where You\'re Going',
      stats: [
        { n: 'NIT', l: 'Hamirpur alumnus mentor' },
        { n: '13+', l: 'Years of selections' },
        { n: '90%+', l: 'Board results alongside' },
        { n: '15', l: 'Max students per batch' },
      ],
      stamp: 'CONCEPT FIRST · RANKS FOLLOW',
      photo: { src: '/images/award2.jpg', fallback: '/images/gallery-award2.svg', caption: 'Sweet success 🏆' },
      line: 'Concept-first Physics and Maths from an NIT graduate, NCERT-anchored Chemistry, weekly NTA-pattern mocks with forensic error analysis — boards and JEE prepared together, not against each other.',
    },
    faqs: [
      { q: 'Can I prepare for boards and JEE together?', a: 'That\'s exactly how we teach — the syllabus is shared. Concepts are taught once, then layered with board answer-writing and JEE problem-solving on top. Our students hold 90%+ board results alongside JEE prep.' },
      { q: 'What happens in the free strategy session?', a: 'Senior faculty runs an NTA-pattern mini-diagnostic across Physics, Chemistry, Maths, then builds your personal plan: percentile target, January/April session calendar, weekly schedule. You keep it, free.' },
      { q: 'Should I attempt both JEE Main sessions?', a: 'Almost always yes. Only your best score counts, so January is a free rehearsal with real stakes. Students who sit both sessions consistently outperform single-attempt peers.' },
      { q: 'Class 11, Class 12 or dropper — when do I join?', a: 'All three tracks run separately. Class 11 builds the two-year foundation, Class 12 integrates boards + JEE, droppers get a full-syllabus high-intensity cycle with doubled mock frequency.' },
      { q: 'What about fees?', a: 'Fees are set on your family\'s ability and stay affordable — far less than metro coaching. Your exact fee is confirmed in the free strategy session. No capable engineer is turned away over money.' },
    ],
    meta: {
      title: 'JEE Coaching in Una — Learn From An NIT Graduate | Free Strategy Session',
      description: 'JEE Mains coaching in Una, HP by an NIT Hamirpur alumnus — concept-first Physics & Maths, weekly NTA-pattern mocks, boards + JEE together. Book a free 1-on-1 strategy session + diagnostic.',
    },
  },
}
