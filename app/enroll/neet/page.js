...
const cfg = getExamLanding('neet')

export const metadata = {
  title: cfg.meta.title,
  description: cfg.meta.description,
  alternates: { canonical: `${SITE.url}/enroll/neet` },
  openGraph: {
    title: cfg.meta.title,
    description: cfg.meta.description,
    url: `${SITE.url}/enroll/neet`,
    type: 'website',
  },
}
...
const SCHEMA = [
  {
    ...
    '@type': 'Course',
    name: 'NEET Coaching in Una — Free Strategy Session',
    description: cfg.meta.description,
...
export default function NeetEnrollPage() {
  return (
    <>
